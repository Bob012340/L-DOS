...
VolumeLabel		db "L-DOS      "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "MCP     COM"	; MikeOS kernel filename

	disk_error	db "Floppy error! Press any key...", 0
	file_not_found	db "MCP.COM not found!", 0
